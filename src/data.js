...
// Интервал замены моторного масла по умолчанию (0W-20 на Prius+). Подставляется
// в блок «Следующая замена» при включении плана для категории «Масло»;
// пользователь может изменить его перед сохранением. Только по пробегу:
// срок по времени — отдельная, необязательная настройка пользователя.
export const OIL_INTERVAL_DEFAULTS = { km: 15000 };
